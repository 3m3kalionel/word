const words = require('../app.js').words;
...
describe("using jasmine.objectContaining", function() {
    ...
    beforeEach(function() {
        wordCount = words("andela bootcamp hectic, andela fellowship hectic");
    });

    it("matches objects with the expect key/value pairs", function() {

        expect(wordCount).toEqual(jasmine.objectContaining({
            andela: 2
        }));

        expect(wordCount).not.toEqual(jasmine.objectContaining({
           hectic: 2 
    }));
